...
Design = Design[3, ]
  ...
  sP=Design[5]
  games=1000
  if(sum(Design)==1.8){games=5500} # 10 times more post-burnin iterations in the baseline condition to have a better estimate of the variances
  ...
  save(res_double,Design,file="output/ResultsDoubleElo_2.RData")
