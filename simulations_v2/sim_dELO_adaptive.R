...
for(j in 1:nrow(Design)){
  ...
  if(K==0.2){games=1250}
  res_double[[j]]=elo_double(n=1000, m=200, reps=200,games=games,K=K,mP=mP,sP=sP,m_d=m_d,s_d=s_d)
  save(res_double,Design,file="output/ResultsDoubleElo_1.RData")
}
